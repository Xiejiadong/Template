...
# Foreigner的计算集合
包含很多大写，可能队友不喜欢，但是我喜欢（逃
## 点
```cpp
#define y1 yy1 // 防止编译错误，很关键
...
bool compare_y(P a, P b) { return a.y < b.y;}

LD closest_pair(P *a, int n) {
    if (n <= 1) return INF;
    int m = n/2;
    LD x = a[m].x;
